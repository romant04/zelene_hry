export function generateLetters(count = 14) {
  ...
  const consonants = ["B", "C", "F", "G", "H", "J", "R", "Z", "Y"]; // Y is chosen as a consonant here for lowering its frequency in the generated letters
  ...
  const frequentCount = Math.floor(count * 0.5);
