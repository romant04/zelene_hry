...
<script lang="ts">
	let counter = $state(0);
	const multiplied = $derived(counter * 10);
...
<div class="container h-full mx-auto flex justify-center items-center">
	<div class="space-y-10 text-center flex flex-col items-center">
		...
		<div class="flex flex-col gap-5">
			<p class="text-lg flex gap-2 items-center"><span class="text-xs">x10</span>{multiplied}</p>
			<button onclick={handleIncrement} class="btn variant-filled">+</button>
		</div>
		<div class="space-y-2">
