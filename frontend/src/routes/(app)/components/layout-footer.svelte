<script lang="ts">
	...
	const LINKS = [
		...
		},
		{
			...
			links: [
				{
					label: '+420 630 520 710'
				},
				{
					label: 'info@duelovky.cz',
					href: '#'
				}
			]
		}
...
<footer class="mt-20 flex min-h-[24rem] flex-col justify-between bg-tertiary-700 pt-10">
			...
			<div class="w-full max-w-[24rem]">
				...
				<form class="w-full">
					...
					<div class="mt-2">
						...
						<textarea
							name="bug-desc"
							class="textarea resize-none !bg-tertiary-800 p-2 text-sm"
							rows="3"
						></textarea>
					</div>
					<button class="btn h-9 w-full bg-secondary-700">Náhlasit bug</button>
				</form>
			</div>
		</div>
	</section>
	...
	<section class="mt-8 flex md:flex-row gap-8 flex-col w-full items-center justify-between bg-tertiary-800 px-6 py-2">
		...
		<p class="text-xs">&copy; Copyright - Roman Tarnai 2024</p>
	</section>
</footer>
